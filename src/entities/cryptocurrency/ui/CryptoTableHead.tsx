  ...
  return (
    <thead className={`sticky top-0 z-10 transition-shadow duration-200`}>
      <tr className="border-b border-[#2A2A2A] bg-[#0F0F0F]">
        <th
          onClick={() => onSort("rank")}
          className="px-4 py-4 text-left text-xs font-medium text-[#a0a0a0] hover:text-white uppercase tracking-wider cursor-pointer transition-colors bg-[#0F0F0F]"
        >
        ...
        <th
          ...
          className="px-4 py-4 text-right text-xs font-medium text-[#a0a0a0] hover:text-white uppercase tracking-wider cursor-pointer transition-colors bg-[#0F0F0F]"
        >
